...
public class Report_Section_main extends AppCompatActivity implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.report_section_main_lay);

        back = (ImageView) findViewById(R.id.back);

        db = new DatabaseHelper(Report_Section_main.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //startActivity(new Intent(Report_Section_main.this,panel_main.class));
                Intent backs = new Intent(Report_Section_main.this,panel_main.class);
        ...
        if(cursor.moveToFirst()){
            ...
            Report_Section_main_adapter classess_adapter = new Report_Section_main_adapter(Report_Section_main.this,ids,sections_name);
        ...
        if(query.equals("")){
            ...
            if(cursor != null){
                if(cursor.moveToFirst()){
                    ...
                    Report_Section_main_adapter classess_adapter = new Report_Section_main_adapter(Report_Section_main.this,id_s,sec_names_s);
                    list_view_section_name.setAdapter(classess_adapter);
