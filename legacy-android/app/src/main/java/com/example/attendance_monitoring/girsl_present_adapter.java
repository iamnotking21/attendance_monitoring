...
public class girsl_present_adapter extends BaseAdapter {
    Context context;
    LayoutInflater inflater;
    ArrayList<String> id,firstname,lastname,oras_start,oras_end,oras_end_late,title ;

    public girsl_present_adapter(Context acontext, ArrayList<String> id,ArrayList<String> firstname,ArrayList<String> lastname,ArrayList<String> title,ArrayList<String> oras_start,ArrayList<String> oras_end,ArrayList<String> oras_end_late){
    ...
    public View getView(int i, View view, ViewGroup parent) {
        view = inflater.inflate(R.layout.girls_present_adapter_lay,null);
