...
public class girls_attendance_record_summary_adapter extends BaseAdapter {
    Context context;
    ...
    public girls_attendance_record_summary_adapter(Context acontext, ArrayList<String> student_number,ArrayList<String> lastname,ArrayList<String> firstname,String startdate,String enddate){
    ...
    public View getView(int i, View view, ViewGroup parent) {
        view = inflater.inflate(R.layout.girls_attendance_record_summary_adapter_lay,null);
